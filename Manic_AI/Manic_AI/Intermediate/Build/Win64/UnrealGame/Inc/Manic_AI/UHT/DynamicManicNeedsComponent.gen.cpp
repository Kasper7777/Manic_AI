...
template<> MANIC_AI_API UScriptStruct* StaticStruct<FNeedData>()
{
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_bLockToThreshold_MetaData[];
#endif
		static void NewProp_bLockToThreshold_SetBit(void* Obj);
		static const UECodeGen_Private::FBoolPropertyParams NewProp_bLockToThreshold;
#if WITH_METADATA
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FNeedData_Statics::Struct_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		{ "Comment", "/**\n * Represents one \xe2\x80\x9cneed\xe2\x80\x9d (Name, DefaultValue, Threshold, direction, rate, etc.).\n */" },
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FNeedData_Statics::NewProp_DefaultValue_MetaData[] = {
		{ "Category", "Need" },
		{ "Comment", "// The default value of this need (e.g. 100 for \"Health\" or 0 for \"Hunger\").\n" },
		{ "ModuleRelativePath", "Public/DynamicManicNeedsComponent.h" },
		{ "ToolTip", "The default value of this need (e.g. 100 for \"Health\" or 0 for \"Hunger\")." },
	};
#endif
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FNeedData_Statics::NewProp_bTickUp_MetaData[] = {
		{ "Category", "Need" },
		{ "Comment", "// Whether this need is increasing (tick up) or decreasing (tick down).\n" },
		{ "ModuleRelativePath", "Public/DynamicManicNeedsComponent.h" },
		{ "ToolTip", "Whether this need is increasing (tick up) or decreasing (tick down)." },
	};
#endif
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FNeedData_Statics::NewProp_TickRate_MetaData[] = {
		{ "Category", "Need" },
		{ "ClampMin", "0.0" },
		{ "Comment", "// Rate at which the need changes per second.\n// For example, TickRate=2 means it changes 2 points per second.\n" },
		{ "ModuleRelativePath", "Public/DynamicManicNeedsComponent.h" },
		{ "ToolTip", "Rate at which the need changes per second.\nFor example, TickRate=2 means it changes 2 points per second." },
	};
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FNeedData_Statics::NewProp_bLockToThreshold_MetaData[] = {
		{ "Category", "Need" },
		{ "Comment", "// If true, once the need hits the Threshold, it clamps there\n// rather than going below (if ticking down) or above (if ticking up).\n" },
		{ "ModuleRelativePath", "Public/DynamicManicNeedsComponent.h" },
		{ "ToolTip", "If true, once the need hits the Threshold, it clamps there\nrather than going below (if ticking down) or above (if ticking up)." },
	};
#endif
	void Z_Construct_UScriptStruct_FNeedData_Statics::NewProp_bLockToThreshold_SetBit(void* Obj)
	{
		((FNeedData*)Obj)->bLockToThreshold = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FNeedData_Statics::NewProp_bLockToThreshold = { "bLockToThreshold", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FNeedData), &Z_Construct_UScriptStruct_FNeedData_Statics::NewProp_bLockToThreshold_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNeedData_Statics::NewProp_bLockToThreshold_MetaData), Z_Construct_UScriptStruct_FNeedData_Statics::NewProp_bLockToThreshold_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FNeedData_Statics::NewProp_CurrentValue_MetaData[] = {
		{ "Category", "Need" },
		{ "Comment", "// Runtime fields (not typically edited at design time)\n" },
		{ "ModuleRelativePath", "Public/DynamicManicNeedsComponent.h" },
		{ "ToolTip", "Runtime fields (not typically edited at design time)" },
	};
#endif
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FNeedData_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FNeedData_Statics::NewProp_bLockToThreshold,
...
void FOnAnyNeedThreshold_DelegateWrapper(const FMulticastScriptDelegate& OnAnyNeedThreshold, FName CrossedNeedName)
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UDelegateFunction_Manic_AI_OnAllNeedsUpdated__DelegateSignature_Statics::NewProp_UpdatedNeeds_Inner = { "UpdatedNeeds", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FNeedData, METADATA_PARAMS(0, nullptr) }; // 1242125045
#if WITH_METADATA
...
void FOnAllNeedsUpdated_DelegateWrapper(const FMulticastScriptDelegate& OnAllNeedsUpdated, TArray<FNeedData> const& UpdatedNeeds)
{
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UDynamicManicNeedsComponent_TickAllNeeds_Statics::Function_MetaDataParams[] = {
		...
		{ "ModuleRelativePath", "Public/DynamicManicNeedsComponent.h" },
		{ "ToolTip", "Called each frame from Event Tick, e.g.:\nEvent Tick (DeltaTime) -> TickAllNeeds(DeltaTime)" },
	};
#endif
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UDynamicManicNeedsComponent_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UDynamicManicNeedsComponent_TickAllNeeds, "TickAllNeeds" }, // 2650350232
	};
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UDynamicManicNeedsComponent_Statics::NewProp_Needs_MetaData[] = {
		...
		{ "Comment", "// The array of needs\n" },
		{ "ModuleRelativePath", "Public/DynamicManicNeedsComponent.h" },
		{ "ToolTip", "The array of needs" },
	};
#endif
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UDynamicManicNeedsComponent_Statics::NewProp_OnAnyNeedThresholdCrossed_MetaData[] = {
		...
		{ "Comment", "// Broadcast when ANY need crosses its threshold\n" },
		{ "ModuleRelativePath", "Public/DynamicManicNeedsComponent.h" },
		{ "ToolTip", "Broadcast when ANY need crosses its threshold" },
	};
#endif
	...
	struct Z_CompiledInDeferFile_FID_HostProject_Plugins_Manic_AI_Source_Manic_AI_Public_DynamicManicNeedsComponent_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_Manic_AI_Source_Manic_AI_Public_DynamicManicNeedsComponent_h_Statics::ScriptStructInfo[] = {
		{ FNeedData::StaticStruct, Z_Construct_UScriptStruct_FNeedData_Statics::NewStructOps, TEXT("NeedData"), &Z_Registration_Info_UScriptStruct_NeedData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNeedData), 1242125045U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_Manic_AI_Source_Manic_AI_Public_DynamicManicNeedsComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDynamicManicNeedsComponent, UDynamicManicNeedsComponent::StaticClass, TEXT("UDynamicManicNeedsComponent"), &Z_Registration_Info_UClass_UDynamicManicNeedsComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDynamicManicNeedsComponent), 2470813613U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_Manic_AI_Source_Manic_AI_Public_DynamicManicNeedsComponent_h_65309632(TEXT("/Script/Manic_AI"),
		Z_CompiledInDeferFile_FID_HostProject_Plugins_Manic_AI_Source_Manic_AI_Public_DynamicManicNeedsComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_Manic_AI_Source_Manic_AI_Public_DynamicManicNeedsComponent_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_HostProject_Plugins_Manic_AI_Source_Manic_AI_Public_DynamicManicNeedsComponent_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_Manic_AI_Source_Manic_AI_Public_DynamicManicNeedsComponent_h_Statics::ScriptStructInfo),
		nullptr, 0);
